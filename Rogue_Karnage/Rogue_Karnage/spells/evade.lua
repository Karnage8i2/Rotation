...
local function out_of_combat()
    ...
    -- Respect global Disable Auto Movement toggle
    if menu_module and menu_module.menu_elements and menu_module.menu_elements.disable_auto_movement 
       and menu_module.menu_elements.disable_auto_movement:get() then
        return false
    end
