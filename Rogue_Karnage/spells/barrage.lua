...
local function logics(target)
    ...
    -- Simple safety check: don't cast Barrage if there are no enemies nearby
    local nearby_enemies = {}
    pcall(function()
        nearby_enemies = utility.get_units_inside_circle_list(player_position, spell_range) or {}
    end)
